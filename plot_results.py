...
from functions.importation import copy, gdal, os
...
"""
f = open('./train_states/2022_06_28_11_03_02/training_parameters.json', 'r', encoding='utf-8')
args = json.load(f.read())
f.close()
"""

args["save_dir"] = "./train_states/2022_07_05_16_20_58/models/"

#deployment_directory = deploy_model(args, shapefile_path, save_location) # perform prediction on given areas
deployment_directory = "./deployments/2022_06_28_11_03_02/2022_07_05_16_44_03/"
